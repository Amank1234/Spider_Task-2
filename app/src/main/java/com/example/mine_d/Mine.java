                        ...
                        if (cp == 0) {
                            ...
                            if (j == 0) {
                                ...
                                if ((i + 1 == x1 || i - 1 == x1) && (i != x2 && i != x2 - 1 && i != x2 + 1)) {
                                    ...
                                    canvas.drawText("1", i * cellWidth, (j + 1) * cellHeight, paint);
                                    ...
                                    paint.setColor(Color.BLACK);
                                    paint.setTextSize(100);
                                    canvas.drawText("2", i * cellWidth, (j + 1) * cellHeight, paint);
                                } else {
                                    cp++;
                                    paint.setColor(Color.BLACK);
                                    paint.setTextSize(100);
                                    canvas.drawText("0", i * cellWidth, (j + 1) * cellHeight, paint);
                                }
...
//                    else if((i+1==x2||i-1==x2)&&(i==x1||i+1==x1||i-1==x1)&&(i==x3||i+1==x3||i-1==x3))
                                    ...
                                    paint.setColor(Color.BLACK);
                                    paint.setTextSize(100);
                                    canvas.drawText("3", i * cellWidth, (j + 1) * cellHeight, paint);
                                } else {
                                    cp++;
                                    paint.setColor(Color.BLACK);
                                    paint.setTextSize(100);
...
//                    else if((i+1==x7||i-1==x7)&&(i==x6||i+1==x6||i-1==x6)&&(i==x8||i+1==x8||i-1==x8))
                            ...
                            canvas.drawRect(x1 * cellWidth, 0 * cellHeight,
                                    (x1 + 1) * cellWidth, (0 + 1) * cellHeight,
                                    blackPaint);
                            blackPaint.setColor(Color.RED);
                            canvas.drawRect(x2 * cellWidth, 1 * cellHeight,
                                    (x2 + 1) * cellWidth, (1 + 1) * cellHeight,
                                    blackPaint);
                            blackPaint.setColor(Color.RED);
                            canvas.drawRect(x3 * cellWidth, 2 * cellHeight,
                                    (x3 + 1) * cellWidth, (2 + 1) * cellHeight,
                                    blackPaint);
                            blackPaint.setColor(Color.RED);
                            canvas.drawRect(x4 * cellWidth, 3 * cellHeight,
                                    (x4 + 1) * cellWidth, (3 + 1) * cellHeight,
                                    blackPaint);
                            blackPaint.setColor(Color.RED);
                            canvas.drawRect(x5 * cellWidth, 4 * cellHeight,
                                    (x5 + 1) * cellWidth, (4 + 1) * cellHeight,
                                    blackPaint);
                            blackPaint.setColor(Color.RED);
                            canvas.drawRect(x6 * cellWidth, 5 * cellHeight,
                                    (x6 + 1) * cellWidth, (5 + 1) * cellHeight,
                                    blackPaint);
                            blackPaint.setColor(Color.RED);
                            canvas.drawRect(x7 * cellWidth, 6 * cellHeight,
                                    (x7 + 1) * cellWidth, (6 + 1) * cellHeight,
                                    blackPaint);
                            blackPaint.setColor(Color.RED);
                            canvas.drawRect(x8 * cellWidth, 7 * cellHeight,
                                    (x8 + 1) * cellWidth, (7 + 1) * cellHeight,
                                    blackPaint);
