...
public class Minede extends View {
    ...
    public Minede(Context context, Context context1) {
        super(context);
        ...
        if(x8<3)
        {
            y8 = 3 + new Random().nextInt(5);
        }
        else
        {
            y8 = new Random().nextInt(3);
        }
    }

    public Minede(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
            ...
            for (int i = 0; i < numColumns; i++) {
                for (int j = 0; j < numRows; j++) {
                    if (cellChecked[i][j]) {
                        ...
                        if ((i == x1 && j == 0) || (i==y1 && j==0)|| (i == x2 && j == 1) || (i == x3 && j == 2) || (i == x4 && j == 3) || (i == x5 && j == 4) || (i == x6 && j == 5) || (i == x7 && j == 6) || (i == x8 && j == 7) || (i == y8 && j == 7))
                        {
...
//                                    }
                                    ...
                                    if ((i == x7 - 1 || i == x7 + 1) && (i != x8 && i != (x8 - 1) && i != (x8 + 1)) && (i != x6 && i != (x6 - 1) && i != (x6 + 1)) && (i != y8 && i != (y8 - 1) && i != (y8 + 1))) {
                                        cp++;
                                        paint.setColor(Color.BLACK);
                                        paint.setTextSize(100);
                                        canvas.drawText("1", i * cellWidth, (j + 1) * cellWidth, paint);
...
//                    else if((i==x1||i+1==x1||i-1==x1))
                                    else if ((i != x7 - 1 && i != x7 + 1) && (i == x8 || i == (x8 - 1) || i == (x8 + 1)) && (i != x6 && i != (x6 - 1) && i != (x6 + 1)) && (i != y8 && i != (y8 - 1) && i != (y8 + 1))) {
                                        cp++;
                                        paint.setColor(Color.BLACK);
                                        paint.setTextSize(100);
                                        canvas.drawText("1", i * cellWidth, (j + 1) * cellWidth, paint);
...
//                                        canvas.drawText("0", i * cellWidth, (j + 1) * cellWidth, paint);
//                                    }
                                    if ((i + 1 == x8 || i - 1 == x8) && (i != x7 && i != x7 - 1 && i != x7 + 1) && (i!=y8 - 1 && i!=y8 + 1))
                                    {
                                        cp++;
                                        paint.setColor(Color.BLACK);
                                        paint.setTextSize(100);
                                    ...
                                    else if ((i == x7 || i + 1 == x7 || i - 1 == x7) && (i != x8 - 1 && i != x8 + 1)&&(i!=y8 - 1 && i!=y8 + 1)) {
                                        cp++;
                                        paint.setColor(Color.BLACK);
                                        paint.setTextSize(100);
                                        canvas.drawText("1", i * cellWidth, (j + 1) * cellWidth, paint);
                                    }
                                    else if((i != x8 - 1 && i != x8 + 1) && (i != x7 && i != x7 - 1 && i != x7 + 1) && (i+1 == y8 || i-1 ==y8))
                                    {
                                        cp++;
                                        paint.setColor(Color.BLACK);
                                        paint.setTextSize(100);
                                    ...
                                    else if ((i + 1 == x8 || i - 1 == x8) && (i == x7 || i + 1 == x7 || i - 1 == x7) && (i!=y8 - 1 && i!=y8 + 1))
                                    {
                                        cp++;
                                        paint.setColor(Color.BLACK);
                                        paint.setTextSize(100);
                                    ...
                                    else if((i + 1 == x8 || i - 1 == x8) && (i != x7 && i != x7 - 1 && i != x7 + 1) && (i+1 == y8 || i-1 ==y8))
                                    {
                                        cp++;
                                        paint.setColor(Color.BLACK);
                                        paint.setTextSize(100);
                                    ...
                                    else if((i != x8 - 1 && i != x8 + 1) && (i == x7 || i + 1 == x7 || i - 1 == x7) && (i+1 == y8 || i-1 ==y8))
                                    {
                                        cp++;
                                        paint.setColor(Color.BLACK);
                                        paint.setTextSize(100);
                                    ...
                                    else if((i + 1 == x8 || i - 1 == x8) && (i == x7 || i + 1 == x7 || i - 1 == x7) && (i+1 == y8 || i-1 ==y8))
                                    {
                                        cp++;
                                        paint.setColor(Color.BLACK);
                                        paint.setTextSize(100);
                            ...
                            else
                            {
                                ...
                                canvas.drawRect(x8 * cellWidth, 7 * cellWidth,
                                        ...
                                        blackPaint);
                                blackPaint.setColor(Color.RED);
                                canvas.drawRect(y8 * cellWidth, 7 * cellWidth,
                                        (y8 + 1) * cellWidth, (7 + 1) * cellWidth,
                                        blackPaint);
                                count++;
                                new Handler().postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent i1 = new Intent(context, MainActivity9.class);
...
//            T.cancel();
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i2 = new Intent(context, MainActivity10.class);
